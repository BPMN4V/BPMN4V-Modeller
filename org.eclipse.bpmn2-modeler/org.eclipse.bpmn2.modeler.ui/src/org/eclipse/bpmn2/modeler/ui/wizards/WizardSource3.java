...
public class WizardSource3 extends WizardPage implements IConstants {
	 ...
	 * @param pageName
	 */
	public WizardSource3(ISelection selection) {
		super("wizardPageS3"); //$NON-NLS-1$
	...
	public void createControl(Composite parent) {
		...
		idds3 = new Label(container, SWT.NONE);
		ids3 = selectTaskId();
		idds3.setText(ids3);
		UpdateTaskId(ids3);
		idds3.setVisible(false);
		...
		UpdateMessageFlowNumber st = new UpdateMessageFlowNumber();
		  ...
		  if(stateP.compareTo("Stable")==0 ) {
			  ...
			  processStableS3=idprocess;
				UpdateMessageFlowNumber upm = new UpdateMessageFlowNumber();
				String nameS3 = upm.selectNameProcess(p.getProcessRef().getId());
				
			  int response = JOptionPane
						.showConfirmDialog(null, "The version of process source of interaction: "+nameS3+"  is Stable. Do you want to derive it?",
				...
				if (response == JOptionPane.NO_OPTION) {
					...
					System.out.println("Yes button clicked");
					 ...
					 String idS;
				  idS=  upm.SelectLastVProcess(nameS3);
	...
	public IWizardPage getNextPage(IWizardPage WizardTarget3) {
		return WizardTarget3;
	}
