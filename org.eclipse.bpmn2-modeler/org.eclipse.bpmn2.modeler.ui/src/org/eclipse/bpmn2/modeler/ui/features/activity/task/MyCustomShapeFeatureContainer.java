...
import org.eclipse.bpmn2.modeler.ui.features.activity.task.CustomShapeFeatureContainer.AddCustomShapeFeature;
...
public class MyCustomShapeFeatureContainer extends MyCustomElementFeatureContainer implements IShapeFeatureContainer {
	...
	public IAddFeature getAddFeature(IFeatureProvider fp) {
		return new MyAddCustomShapeFeature(fp);
	}
	 ...
	 */
	public class MyCreateCustomShapeFeature extends AbstractBpmn2CreateFeature<BaseElement> {

		protected AbstractBpmn2CreateFeature<BaseElement> createFeatureDelegate;
		
		@SuppressWarnings({ "unchecked", "rawtypes" })
		public MyCreateCustomShapeFeature(IFeatureProvider fp, String name, String description) {
	...
	public class MyAddCustomShapeFeature extends AbstractBpmn2AddFeature<BaseElement> {
		 ...
		 * @param fp
		 */
		public MyAddCustomShapeFeature(IFeatureProvider fp) {
			super(fp);
