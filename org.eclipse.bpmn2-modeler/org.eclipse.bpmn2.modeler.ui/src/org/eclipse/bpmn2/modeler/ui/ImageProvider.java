...
public class ImageProvider extends AbstractImageProvider {
	...
	public static final String IMG_16_VERSIONS = "org.eclipse.bpmn2.modeler.icons." + "version" + dot16; //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected void addAvailableImages() {
		...
		addImageFilePath(IMG_16_VERSIONS, ICONS_16 + "version.png"); //$NON-NLS-1$
