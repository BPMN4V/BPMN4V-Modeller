...
import org.eclipse.bpmn2.modeler.ui.features.activity.task.CustomConnectionFeatureContainer.AddCustomConnectionFeature;
...
public class MyCustomConnectionFeatureContainer extends MyCustomElementFeatureContainer implements IConnectionFeatureContainer {
	...
	public ICreateConnectionFeature getCreateConnectionFeature(IFeatureProvider fp) {
		return new MyCreateCustomConnectionFeature(fp);
	}
	 ...
	 */
	public class MyCreateCustomConnectionFeature extends AbstractBpmn2CreateConnectionFeature<BaseElement, EObject, EObject> {

		protected AbstractBpmn2CreateConnectionFeature createFeatureDelegate;
		
		public MyCreateCustomConnectionFeature(IFeatureProvider fp, String name, String description) {
		...
		public MyCreateCustomConnectionFeature(IFeatureProvider fp) {
