...
import org.eclipse.bpmn2.modeler.ui.features.activity.task.CustomElementFeatureContainer.AddCustomElementFeature;
...
public class MyCustomElementFeatureContainer implements ICustomElementFeatureContainer {
	...
	public IAddFeature getAddFeature(IFeatureProvider fp) {
		return new MyAddCustomElementFeature(fp);
	}

	public class MyAddCustomElementFeature extends AbstractBpmn2AddFeature<BaseElement> {
		 ...
		 * @param fp
		 */
		public MyAddCustomElementFeature(IFeatureProvider fp) {
			super(fp);
