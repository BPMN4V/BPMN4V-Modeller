...
public class BPMN2VersionEditorOutlinePage extends ContentOutlinePage implements IPropertyListener, IAdaptable {

	// The IDs to identify the outline and the thunbnail
	public static final int ID_BUSINESS_MODEL_OUTLINE = 3;
	public static final int ID_INTERCHANGE_MODEL_OUTLINE = 4;
	public static final int ID_THUMBNAIL = 5;
	...
	private EditDomain editDomain1;
	 ...
	 * @since 0.9
	 */
	public BPMN2VersionEditorOutlinePage(DiagramEditor diagramEditor) {
		...
		editDomain1 = diagramEditor.getEditDomain();
		keyHandler1 = (KeyHandler) diagramEditor.getAdapter(KeyHandler.class);
...
//		actionBars.updateActionBars();
	...
	public void createControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, "Version Outline View");
	}
	...
	protected void createOutlineViewer() {
		...
		getViewer().setEditDomain(editDomain1);
		getViewer().setKeyHandler(keyHandler1);
