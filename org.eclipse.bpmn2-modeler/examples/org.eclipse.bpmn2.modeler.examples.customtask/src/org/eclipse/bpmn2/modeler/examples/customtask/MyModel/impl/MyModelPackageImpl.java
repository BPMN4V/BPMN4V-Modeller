...
public class MyModelPackageImpl extends EPackageImpl implements MyModelPackage {
	...
	private EClass AdaptationPatterncase1EClass = null;
	 ...
	 * @generated
	 */
	public EClass getAdaptationPatterncase1() {
		return AdaptationPatterncase1EClass;
	}
	...
	@Override
	public EClass getAdaptationPattern() {
