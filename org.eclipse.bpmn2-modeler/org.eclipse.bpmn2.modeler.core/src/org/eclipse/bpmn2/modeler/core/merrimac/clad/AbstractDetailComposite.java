...
import org.eclipse.bpmn2.modeler.core.merrimac.dialogs.DateCellEditor;
...
import org.eclipse.bpmn2.modeler.core.merrimac.dialogs.TreeObjectEditor;
...
//	    section.setTextClient(toolbar);
	...
	protected void bindAttribute(Composite parent, EObject object, EAttribute attribute, String label) {
		...
		if (isModelObjectEnabled(object.eClass(), attribute) || "anyAttribute".equals(attribute.getName())) { //$NON-NLS-1$
			...
			System.out.println("eTypeClass"+attribute.getEType().getInstanceClass().toString());
			if (ModelUtil.isMultiChoice(object, attribute)) {
				...
				Control c=editor.createControl(parent,label);
			...
			else if ( java.util.Date.class.equals(eTypeClass) )
			 {DateObjectEditor editor = new DateObjectEditor(this,object,attribute);
			...
			else if ( char.class.equals(eTypeClass) )
			 {
		TreeObjectEditor editor=new TreeObjectEditor(this,object,attribute);
