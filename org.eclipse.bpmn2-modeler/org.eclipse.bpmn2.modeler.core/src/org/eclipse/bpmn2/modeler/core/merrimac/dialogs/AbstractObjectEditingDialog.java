...
//import org.eclipse.bpmn2.modeler.examples.customtask.TaskInformationDetailComposite;
...
public abstract class AbstractObjectEditingDialog extends FormDialog implements ValidationErrorHandler {
	...
	protected void okPressed() {
		...
		dialogContent.dispose();
		super.okPressed();
		//TaskInformationDetailComposite t;
		//System.out.println("bouton ok"+TaskInformationDetailComposite.list.getItem(TaskInformationDetailComposite.list.getSelectionIndex()));
	}
