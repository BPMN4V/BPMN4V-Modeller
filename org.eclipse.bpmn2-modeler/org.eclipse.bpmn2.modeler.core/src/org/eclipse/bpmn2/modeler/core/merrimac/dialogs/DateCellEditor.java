...
public class DateCellEditor extends AbstractCellEditor {
	...
	public void setCanonicalValue(Object canonicalValue) {
		...
		if (editorValue != null) {
			System.out.println("al4"+editorValue.getTime());
	...
	//	dateControl.setFont(this.cellStyle.getAttributeValue(CellStyleAttributes.FONT));
		...
		dateControl.addSelectionListener(new SelectionListener(){
			...
			//	ModelUtil.getValue(object, feature);
				...
				Calendar editorValue = null;
				editorValue = Calendar.getInstance();
				editorValue.set(dateControl.getYear(), dateControl.getMonth(), dateControl.getDay());
				//originalCanonicalValue= this.dateTime.get;
				//System.out.println("sss"+originalCanonicalValue.getClass().getName().toString());
				setCanonicalValue(editorValue);
			}
	...
	public Control activateCell(Composite parent, Object originalCanonicalValue) {
		...
		Calendar editorValue = null;
		editorValue = Calendar.getInstance();
		editorValue.set(this.dateTime.getYear(), this.dateTime.getMonth(), this.dateTime.getDay());
		//originalCanonicalValue= this.dateTime.get;
		//System.out.println("sss"+originalCanonicalValue.getClass().getName().toString());
		setCanonicalValue(editorValue);
